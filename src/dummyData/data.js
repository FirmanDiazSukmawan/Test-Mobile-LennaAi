export const dummyData = {
  ...
  clients: {
    answer: [
      {
        text: `Lenna AI telah melayani berbagai klien di berbagai industri. Beberapa highlight mengenai klien-kelien ini adalah:

        - Lebih dari 100 Pelanggan di Seluruh Dunia: Lenna AI memiliki pengalaman yang luas dalam membangun chatbot untuk berbagai kasus dan integrasi sistem, membantu banyak perusahaan dalam meningkatkan interaksi dan layanan pelanggan mereka.
          
        - Penghargaan: Lenna AI telah mendapatkan beberapa penghargaan termasuk 1 Best Conversational AI Platform yang diselenggarakan oleh Intel Edge AI pada tahun 2021.
